...
export const COMPETITIVE_MODE_CHARGE_COLOR = "#f97316";
export const COMPETITIVE_MODE_DRIFT_INITIAL_SPEED_RATIO = 0.052;
export const COMPETITIVE_MODE_DRIFT_ACCELERATION_RATIO = 0.0015;
export const COMPETITIVE_MODE_DRIFT_MAX_SPEED_RATIO = 0.105;
...
export const TOP_DEATH_IMPACT_HOLD_FRAMES = 2;
